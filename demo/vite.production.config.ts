...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@teamdiverst/easy-email-core': path.resolve('../packages/easy-email-core'),
      '@teamdiverst/easy-email-editor': path.resolve('../packages/easy-email-editor'),
      '@teamdiverst/easy-email-extensions': path.resolve('../packages/easy-email-extensions'),
    },
  },
  optimizeDeps: {},
  define: {},
