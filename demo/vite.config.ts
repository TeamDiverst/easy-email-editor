...
export default defineConfig({
  ...
  resolve: {
    alias: {
      '@teamdiverst/easy-email-editor/lib/style.css': path.resolve(__dirname, 'package.json'), // 没有用的，只是防止css 404报错
      '@teamdiverst/easy-email-extensions/lib/style.css': path.resolve(__dirname, 'package.json'), // 没有用的，只是防止css 404报错
      ...
      '@teamdiverst/easy-email-core': path.resolve('../packages/easy-email-core/src/index.tsx'),
      '@teamdiverst/easy-email-editor/lib/locales.json': path.resolve(
        '../packages/easy-email-editor/public/locales.json',
      ),
      '@teamdiverst/easy-email-localization': path.resolve('../packages/easy-email-localization'),
      '@teamdiverst/easy-email-editor': path.resolve('../packages/easy-email-editor/src/index.tsx'),
      '@teamdiverst/easy-email-extensions': path.resolve(
      ...
      output: {
        manualChunks(id) {
          ...
          if (/easy-email.*/.test(id)) {
            return '@teamdiverst/easy-email-editor';
          }
        },
      },
    },
